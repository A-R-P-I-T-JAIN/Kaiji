...
const citizen1Texture = textureLoader.load('./assets/citizen12.png');
citizen1Texture.colorSpace = SRGBColorSpace;

const citizen2Texture = textureLoader.load('./assets/citizen12.png');
citizen2Texture.colorSpace = SRGBColorSpace;

const citizen3Texture = textureLoader.load('./assets/citizen12.png');
citizen3Texture.colorSpace = SRGBColorSpace;

const citizen4Texture = textureLoader.load('./assets/citizen12.png');
...
const emperorTexture = textureLoader.load('./assets/emperor1.png');
emperorTexture.colorSpace = SRGBColorSpace;

const slaveTexture = textureLoader.load('./assets/slave1.png');
...
const myCardsPositions = [
    new Vector3(0.5, 7.304, 4.51),
    new Vector3(0.25, 7.303, 4.47),
    new Vector3(0, 7.302,4.45),
    new Vector3(-0.25, 7.301, 4.47),
    new Vector3(-0.5, 7.3, 4.51)
];
